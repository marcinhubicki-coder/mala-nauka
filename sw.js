const CACHE='mala-nauka-spelling-v24-narrative-assets';
const CORE=[
  './','./index.html','./app.css','./app.js','./app.js?v=24-narrative-assets','./module-router.js','./spelling-assets-setting.js',
  './game.mjs','./game.mjs?v=2','./game.mjs?v=24-narrative-assets','./modes.mjs','./modes.mjs?v=24-narrative-assets','./progress.mjs',
  './spelling-art.css','./spelling-art.css?v=24-narrative-assets','./debug-tools.js','./debug-tools.js?v=7',
  ...
  './spelling/art.mjs','./spelling/art.mjs?v=24-narrative-assets','./spelling/bubble.mjs','./spelling/bubble.mjs?v=24-narrative-assets',
  './spelling/hints.mjs','./spelling/preview.mjs','./spelling/preview.mjs?v=24-narrative-assets','./spelling/scenes.mjs','./spelling/scenes.mjs?v=24-narrative-assets','./spelling/word-reveal.mjs','./spelling/word-reveal.mjs?v=9-simple-text',
