export const SCENES = new Map([
  ...
  ['c_rka', { key:'corka', asset:'corka.avif', position:'center 48%', layouts:['bubble'] }],
  ['w_zek', { key:'wozek', asset:'wozek.avif', position:'center 48%', layouts:['bubble'] }],
  ['pi_ro', { key:'pioro', asset:'pioro.avif', position:'center 48%', layouts:['bubble'] }],
  ['_semka', { key:'osemka', asset:'osemka.avif', position:'center 48%', layouts:['bubble'] }],
