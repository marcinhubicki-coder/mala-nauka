const CACHE='mala-nauka-spelling-v23-art-library';
const CORE=[
  './','./index.html','./app.css','./app.js','./app.js?v=23-art-library','./module-router.js','./spelling-assets-setting.js',
  './game.mjs','./game.mjs?v=2','./game.mjs?v=23-art-library','./modes.mjs','./modes.mjs?v=23-art-library','./progress.mjs',
  './spelling-art.css','./spelling-art.css?v=23-art-library','./debug-tools.js','./debug-tools.js?v=7',
  ...
  './spelling/art.mjs','./spelling/art.mjs?v=23-art-library','./spelling/bubble.mjs','./spelling/bubble.mjs?v=23-art-library',
  './spelling/hints.mjs','./spelling/preview.mjs','./spelling/preview.mjs?v=23-art-library','./spelling/scenes.mjs','./spelling/scenes.mjs?v=23-art-library','./spelling/word-reveal.mjs','./spelling/word-reveal.mjs?v=9-simple-text',
