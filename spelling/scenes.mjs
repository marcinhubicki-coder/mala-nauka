...
export const WORD_SCENES = new Map([
  ...
  ['cukier', { key:'table-food', asset:'stol.avif', layouts:['bubble'] }],
  ['zupa', { key:'table-food', asset:'stol.avif', layouts:['bubble'] }],
  ['burak', { key:'table-food', asset:'stol.avif', layouts:['bubble'] }],
  ['ugotować', { key:'table-cooking', asset:'stol.avif', layouts:['bubble'] }],
  ['hamburger', { key:'table-food', asset:'stol.avif', layouts:['bubble'] }],
  ['suchar', { key:'table-food', asset:'stol.avif', layouts:['bubble'] }],
  ['okruch', { key:'table-food', asset:'stol.avif', layouts:['bubble'] }],
  ['łyżeczka', { key:'table-spoon', asset:'stol.avif', layouts:['bubble'] }],
  ['pożywienie', { key:'table-food', asset:'stol.avif', layouts:['bubble'] }],
  ...
  ['uczeń', { key:'study', asset:'ksiazka.avif', layouts:['bubble'] }],
  ['uczennica', { key:'study', asset:'ksiazka.avif', layouts:['bubble'] }],
  ['ćwiczyć', { key:'study-exercise', asset:'ksiazka.avif', layouts:['bubble'] }],
  ['ćwiczenie', { key:'study-exercise', asset:'ksiazka.avif', layouts:['bubble'] }],
  ['hasło', { key:'study-password', asset:'ksiazka.avif', layouts:['bubble'] }],
  ['przykład', { key:'study-example', asset:'ksiazka.avif', layouts:['bubble'] }],
