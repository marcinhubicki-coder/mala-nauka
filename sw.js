const CACHE='mala-nauka-spelling-v22-repaired-assets';
const CORE=[
  './','./index.html','./app.css','./app.js','./app.js?v=22-repaired-assets','./module-router.js','./spelling-assets-setting.js',
  './game.mjs','./game.mjs?v=2','./game.mjs?v=6-scene','./modes.mjs','./modes.mjs?v=22-repaired-assets','./progress.mjs',
  './spelling-art.css','./spelling-art.css?v=22-repaired-assets','./debug-tools.js','./debug-tools.js?v=7',
  ...
  './spelling/art.mjs','./spelling/art.mjs?v=22-repaired-assets','./spelling/bubble.mjs','./spelling/bubble.mjs?v=22-repaired-assets',
  './spelling/hints.mjs','./spelling/preview.mjs','./spelling/preview.mjs?v=22-repaired-assets','./spelling/scenes.mjs','./spelling/scenes.mjs?v=22-repaired-assets','./spelling/word-reveal.mjs','./spelling/word-reveal.mjs?v=9-simple-text',
