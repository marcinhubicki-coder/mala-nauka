...
const CORE=[
  ...
  './angielski/','./angielski/index.html','./flagi/','./flagi/index.html','./flagi/language-toggle.mjs','./flagi/europe-map.js','./flagi/feedback-transition.js','./czytanie/','./czytanie/index.html'
];
