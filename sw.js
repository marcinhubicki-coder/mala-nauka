const CACHE='mala-nauka-spelling-v31-membrane';
const CORE=[
  ...
  './','./index.html','./app.css','./app.js','./app.js?v=31-membrane','./module-router.js','./spelling-assets-setting.js',
  ...
  './spelling/art.mjs','./spelling/art.mjs?v=31-membrane','./spelling/bubble.mjs','./spelling/bubble.mjs?v=31-membrane',
