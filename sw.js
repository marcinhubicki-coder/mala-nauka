const CACHE='mala-nauka-spelling-v25-uploaded-scenes';
const CORE=[
  ...
  './','./index.html','./app.css','./app.js','./app.js?v=25-uploaded-scenes','./module-router.js','./spelling-assets-setting.js',
  './game.mjs','./game.mjs?v=2','./game.mjs?v=25-uploaded-scenes','./modes.mjs','./modes.mjs?v=25-uploaded-scenes','./progress.mjs',
  './spelling-art.css','./spelling-art.css?v=25-uploaded-scenes','./debug-tools.js','./debug-tools.js?v=7',
  ...
  './spelling/art.mjs','./spelling/art.mjs?v=25-uploaded-scenes','./spelling/bubble.mjs','./spelling/bubble.mjs?v=25-uploaded-scenes',
  './spelling/hints.mjs','./spelling/preview.mjs','./spelling/preview.mjs?v=25-uploaded-scenes','./spelling/scenes.mjs','./spelling/scenes.mjs?v=25-uploaded-scenes','./spelling/word-reveal.mjs','./spelling/word-reveal.mjs?v=9-simple-text',
