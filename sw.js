const CACHE='mala-nauka-v26-spelling-quality-v052';
const CORE=[
  './','./index.html','./app.css','./app.js','./module-router.js','./spelling-assets-setting.js','./game.mjs','./modes.mjs','./progress.mjs',
  './spelling-art.css','./spelling-mobile.css','./spelling-quality-v052.css','./spelling-art.js','./debug-tools.js',
  './spelling-art.css?v=10','./spelling-mobile.css?v=10','./spelling-quality-v052.css?v=1','./spelling-art.js?v=12','./debug-tools.js?v=7','./spelling/art.mjs?v=9',
  ...
  './assets/ortografia/spelling-bg-v052.svg','./assets/ortografia/title-jak-jest-poprawnie.png','./assets/ortografia/bubble-frame-v051.svg','./assets/ortografia/bubble-mask-v051.svg','./assets/ortografia/answer-button-v051.svg','./assets/ortografia/hint-button-v051.svg',
