const CACHE='mala-nauka-v26-spelling-v051-alpha';
const CORE=[
  './','./index.html','./app.css','./app.js','./module-router.js','./spelling-assets-setting.js','./game.mjs','./modes.mjs','./progress.mjs',
  './spelling-art.css','./spelling-mobile.css','./spelling-review-v041.css','./spelling-mockup-v05.css','./spelling-quality-v051.css','./spelling-art.js','./debug-tools.js',
  './spelling-art.css?v=10','./spelling-mobile.css?v=10','./spelling-review-v041.css?v=2','./spelling-mockup-v05.css?v=1','./spelling-quality-v051.css?v=1','./spelling-art.js?v=11','./debug-tools.js?v=7','./spelling/art.mjs?v=10',
  ...
  './assets/ortografia/spelling-bg-v051.svg','./assets/ortografia/title-jak-jest-poprawnie.png','./assets/ortografia/bubble-frame-v051.svg','./assets/ortografia/bubble-mask-v051.svg','./assets/ortografia/answer-button-v051.svg','./assets/ortografia/hint-button-v051.svg',
