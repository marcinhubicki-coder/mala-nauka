const CACHE='mala-nauka-spelling-v21-simple-text';
const CORE=[
  './','./index.html','./app.css','./app.js','./app.js?v=14-simple-text','./module-router.js','./spelling-assets-setting.js',
  './game.mjs','./game.mjs?v=2','./game.mjs?v=6-scene','./modes.mjs','./modes.mjs?v=2','./progress.mjs',
  './spelling-art.css','./spelling-art.css?v=10-simple-text','./debug-tools.js','./debug-tools.js?v=7',
  ...
  './spelling/art.mjs','./spelling/art.mjs?v=14-simple-text','./spelling/bubble.mjs','./spelling/bubble.mjs?v=10-html-picture',
  './spelling/hints.mjs','./spelling/preview.mjs','./spelling/scenes.mjs','./spelling/scenes.mjs?v=13-scene-assets','./spelling/word-reveal.mjs','./spelling/word-reveal.mjs?v=9-simple-text',
