const CACHE='mala-nauka-spelling-v32-glass-speed';
const CORE=[
  ...
  './','./index.html','./app.css','./app.js','./app.js?v=32-glass-speed','./module-router.js','./spelling-assets-setting.js',
  ...
  './spelling/art.mjs','./spelling/art.mjs?v=32-glass-speed','./spelling/bubble.mjs','./spelling/bubble.mjs?v=32-glass-speed',
