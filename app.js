...
function renderGame() {
 ...
 if(feedback)root.querySelector('[data-action="next"]')?.focus({preventScroll:true});else if(!exposing)root.querySelector(q.kind==='memory'?'.memory-key':'.answer')?.focus({preventScroll:true});
}
